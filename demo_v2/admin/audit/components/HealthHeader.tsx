  ...
  return (
    ...
    >
      ...
      <label className="grid gap-1 text-xs text-white/60">
        ...
        <select
          aria-label="Период"
          className="w-full rounded-lg bg-white/5 px-3 py-2 border border-white/10 focus:ring-2 focus:ring-white/20"
          value={v.range ?? "24h"}
      ...
      <label className="grid gap-1 text-xs text-white/60">
        ...
        <input
          ...
          placeholder="Локация"
          className="
            w-full rounded-lg bg-white/5 px-3 py-2 border border-white/10
