...
export default function QuickActions({
  ...
  return (
    <section
      className={cls(
        "admin-section border-white/12 bg-white/8 p-4",
        className
      )}
      ...
      {error ? (
        ...
        >
          {safe.map((it) => {
            ...
            const commonClass =
              "group block rounded-xl border border-white/12 bg-white/10 p-3 text-white/80 transition hover:border-white/18 hover:bg-white/16 focus:outline-none focus:ring-2 focus:ring-white/30";
