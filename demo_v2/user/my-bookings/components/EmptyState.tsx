  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4 rounded-2xl border border-dashed border-[hsl(var(--border))] bg-[hsl(var(--panel))]/60 px-6 py-20 text-center">
      ...
      <div className="space-y-2">
        <h2 className="text-xl font-semibold text-[hsl(var(--fg))]">Записей не найдено</h2>
        <p className="text-sm text-[hsl(var(--muted))]">Попробуйте изменить фильтры или создайте новую запись.</p>
      </div>
      <Link
