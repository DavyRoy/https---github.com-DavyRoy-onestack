// app/demo/(shared)/analytics/index.ts
// Стабильные демо-данные (без рандома) для аналитики бронирований
...
export type DeficitDay = {
  date: string;               // YYYY-MM-DD
  location: string;
};

/* ========= Данные ========= */
export const ADMIN_BOOKING_KPI: BookingKpi = {
  created: 2150,
  confirmed: 1980,
  completed: 1760,
  cancelled: 210,
...
export const ADMIN_BOOKING_TREND: TrendPoint[] = [
...
export const ADMIN_BOOKING_HEAT: HeatCell[] = [
...
export const ADMIN_DEFICIT_DAYS: DeficitDay[] = [
