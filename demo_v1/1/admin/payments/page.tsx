...
export default function AdminPaymentsPage() {
  ...
  return (
    <div className="grid gap-6 overflow-x-hidden">
      ...
      {/* Бар действий: на мобиле перенос строк и отсутствие горизонтального скролла */}
      ...
      {/* KPI — карточки адаптивные, не создают скролл */}
      <div className="min-w-0">
        <KpiRow
      ...
      {/* Тренд + донат: обёртка без горизонтального скролла, TrendLine уже сам делает overflow-x-auto внутри */}
      ...
      {/* Провайдеры / Вебхуки / Алерты: карточки с min-w-0, чтобы обрезать длинные строки и не расползаться */}
      <div className="grid md:grid-cols-3 gap-4 min-w-0">
        <div className="min-w-0">
      ...
      {/* Сверка: отдельная обёртка, чтобы гарантировать отсутствие горизонтального скролла */}
      <div className="min-w-0">
