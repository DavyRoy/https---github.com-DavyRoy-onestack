  ...
  return (
    <header className="flex flex-col md:flex-row md:items-end md:justify-between gap-3">
      ...
      <div className="min-w-0">
        <h1 className="text-2xl md:text-3xl font-semibold tracking-tight">Платежи (админ)</h1>
      ...
      <div className="flex flex-wrap items-center gap-2 w-full md:w-auto">
        <select
          ...
          className="flex-1 md:flex-none rounded-lg bg-white/5 border border-white/15 px-3 py-2 text-sm text-white outline-none focus:ring-2 focus:ring-white/20"
        >
