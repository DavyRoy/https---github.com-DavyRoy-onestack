...
function MobileTabbarInner() {
  ...
  return (
    <>
      ...
      >
        {currentCategory && (
          <div className="relative">
            ...
            {caretX !== null && (
              <span
                className="pointer-events-none absolute -top-1 h-2 w-2 rotate-45 rounded-[2px] bg-black/80"
                style={{ left: caretX - 4 }}
                aria-hidden
              />
            )}
            ...
            <div
              ...
              className={cn(
                "mx-auto w-[min(94%,560px)] rounded-2xl border border-white/15 bg-black/75 p-3 shadow-2xl backdrop-blur-xl"
              )}
            >
              {/* заголовок */}
                    ...
                    return (
                      <Link
                        ...
                        className={cn(
                          ...
                          "rounded-xl border px-3 text-sm whitespace-nowrap text-center",
      ...
      <div
        className="fixed inset-x-0 bottom-0 z-50 border-t border-white/10 bg-black/60 backdrop-blur-xl sm:hidden"
            ...
            {categories.map((cat) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "inline-flex h-11 snap-start items-center gap-2 rounded-2xl border px-3 text-left",
                    "border-white/15 bg-white/5 hover:bg-white/10 active:scale-[0.98] transition",
                    (anyActive || isOpen) && "bg-white/12 shadow-[0_0_0_1px_rgba(255,255,255,0.12)_inset]"
                  )}
