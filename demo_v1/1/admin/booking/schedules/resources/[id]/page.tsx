      ...
      <header className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        <div>
          <nav className="text-xs text-white/60">
            <Link href="/demo/admin/booking/schedules" className="hover:underline">
              Расписания
            </Link>
            <span className="mx-1 opacity-50">/</span>
            <Link href="/demo/admin/booking/schedules/resources" className="hover:underline">
              Ресурсы
            </Link>
            <span className="mx-1 opacity-50">/</span>
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="/demo/admin/booking/schedules/resources"
            className="rounded-xl border border-white/15 px-3 py-2 bg-white/[0.06] hover:bg-white/[0.1]"
          >
            К списку ресурсов
          </Link>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 text-sm">
          ...
          <div className="flex items-center justify-between sm:block">
            ...
            <div className="mt-0.5 sm:mt-1">
              <span className="rounded bg-white/10 px-2 py-0.5">{res.capacity}</span>
            </div>
          </div>
          <div className="flex items-center justify-between sm:block">
