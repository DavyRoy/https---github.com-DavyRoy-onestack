      ...
      <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-4">
        {safe.map((it) => (
          <Link
            key={it.title}
            href={it.href}
            className="group rounded-xl border border-white/15 bg-white/[0.06] p-3 hover:bg-white/[0.1] transition focus:outline-none focus-visible:ring-2 focus-visible:ring-white/40"
            aria-label={it.title}
          >
