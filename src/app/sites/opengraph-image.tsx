...
export const alt = "OneStack — разработка сайтов";
    ...
    (
      <div style={{ background: BG, width: "100%", height: "100%", display: "flex", flexDirection: "column", padding: "60px 80px", position: "relative" }}>
        ...
        <div style={{ marginTop: 40, display: "flex", flexDirection: "column", gap: 8 }}>
          <span style={{ fontSize: 24, color: `${WHITE}70` }}>Лендинги · Корпоративные · Интернет-магазины · SEO-готовые</span>
          <span style={{ fontSize: 20, color: TEAL }}>onestack24.ru/sites</span>
        </div>
