...
export const alt = "OneStack — digital products & web development";
    ...
    (
      ...
      >
        ...
        <div style={{ marginTop: 40, display: "flex", flexDirection: "column", gap: 8 }}>
          <span style={{ fontSize: 24, color: `${WHITE}70` }}>
            Сайты · Веб-приложения · Мобильные · 150+ проектов
          </span>
          <span style={{ fontSize: 20, color: TEAL }}>onestack24.ru</span>
        </div>
