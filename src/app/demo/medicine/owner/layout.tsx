...
const ROLES = [
  {
    id: 'user',
    label: 'Пациент',
    href: '/demo/medical/user',
    icon: '👤',
    description: 'Запись к врачам',
    color: 'from-blue-500 to-cyan-500'
  },
  {
    id: 'doctor',
    label: 'Врач',
    href: '/demo/medical/doctor',
    icon: '👨‍⚕️',
    description: 'Прием пациентов',
    color: 'from-green-500 to-emerald-500'
  },
  {
    id: 'manager',
    label: 'Менеджер',
    href: '/demo/medical/manager',
    icon: '👨‍💼',
  ...
  },
  {
    id: 'owner',
    label: 'Владелец',
    href: '/demo/medical/owner',
    icon: '👑',
    description: 'Аналитика и бизнес',
    color: 'from-purple-500 to-pink-500'
  }
];

// Конфигурация меню для владельца
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Техническое обслуживание", href: "/demo/medical/owner/modules/clinic-management/maintenance" },
          { label: "Расширение клиники", href: "/demo/medical/owner/modules/clinic-management/expansion" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Производительность", href: "/demo/medical/owner/modules/staff/productivity" },
        ],
      },
    ],
  },
  {
    key: "patients-analytics",
    title: "ПАЦИЕНТЫ",
    icon: "📈",
    items: [
      {
        label: "Аналитика пациентов",
        ...
        children: [
          ...
          { label: "Приток новых пациентов", href: "/demo/medical/owner/modules/patients-analytics/new" },
          { label: "Удержание пациентов", href: "/demo/medical/owner/modules/patients-analytics/retention" },
          { label: "География пациентов", href: "/demo/medical/owner/modules/patients-analytics/geography" },
          { label: "Отзывы и рейтинги", href: "/demo/medical/owner/modules/patients-analytics/reviews" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Популярные услуги", href: "/demo/medical/owner/modules/services/popular" },
          ...
          { label: "Рентабельность услуг", href: "/demo/medical/owner/modules/services/profitability" },
          { label: "Пакеты услуг", href: "/demo/medical/owner/modules/services/packages" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        href: "/demo/medical/owner/modules/marketing",
        icon: "🎯",
        children: [
          { label: "Маркетинговая стратегия", href: "/demo/medical/owner/modules/marketing" },
          { label: "Рекламные кампании", href: "/demo/medical/owner/modules/marketing/campaigns" },
          { label: "SEO и онлайн-продвижение", href: "/demo/medical/owner/modules/marketing/seo" },
          { label: "Социальные сети", href: "/demo/medical/owner/modules/marketing/social" },
          { label: "Партнерские программы", href: "/demo/medical/owner/modules/marketing/partnerships" },
          { label: "Бренд клиники", href: "/demo/medical/owner/modules/marketing/brand" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Экспорт данных", href: "/demo/medical/owner/modules/reports/export" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Интеграции", href: "/demo/medical/owner/modules/settings/integrations" },
          { label: "Резервное копирование", href: "/demo/medical/owner/modules/settings/backup" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Подписка и тарифы", href: "/demo/medical/owner/modules/profile/subscription" },
          { label: "Смена роли", href: "/demo/medical/owner/modules/profile/roles" },
        ],
      },
    ],
  },
...
const RoleSwitcher = () => {
  ...
  const currentRole = useMemo(() => {
    ...
    if (pathname.includes('/doctor')) return ROLES[1]; // doctor
    return ROLES[0]; // user
  }, [pathname]);
    ...
    <div className="hidden lg:fixed lg:inset-y-0 lg:z-40 lg:flex lg:w-80 lg:flex-col">
      ...
      >
        ...
        <div className="shrink-0 pt-4">
          <div className="flex h-20 items-center gap-3 mb-4">
            ...
            <div className="flex-1 min-w-0">
              <div className="font-bold text-white/90 text-sm truncate">Александр Петров</div>
              <div className="text-white/70 text-xs font-medium">Владелец клиники</div>
            </div>
          </div>
        ...
        <motion.div 
          ...
          whileHover={{ y: -1 }}
          onClick={() => router.push('/demo/medical/owner/modules/profile')}
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="text-xs text-white/70 truncate">Владелец "МедЦентр"</div>
          </div>
          <motion.span
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-white/70 text-xs">Аналитика и бизнес</div>
            </div>
          </div>
