...
// Конфигурация меню для пациента
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Диагностика", href: "/demo/medical/user/modules/appointments/diagnostics" },
          { label: "Консультации", href: "/demo/medical/user/modules/appointments/consultations" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Терапевты", href: "/demo/medical/user/modules/doctors/therapists" },
          { label: "Хирурги", href: "/demo/medical/user/modules/doctors/surgeons" },
          { label: "Кардиологи", href: "/demo/medical/user/modules/doctors/cardiologists" },
          { label: "Неврологи", href: "/demo/medical/user/modules/doctors/neurologists" },
          { label: "Педиатры", href: "/demo/medical/user/modules/doctors/pediatricians" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Прививки", href: "/demo/medical/user/modules/medical-records/vaccinations" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Диагностика", href: "/demo/medical/user/modules/services/diagnostics" },
          ...
          { label: "Стационар", href: "/demo/medical/user/modules/services/hospital" },
          { label: "Реабилитация", href: "/demo/medical/user/modules/services/rehabilitation" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Льготы", href: "/demo/medical/user/modules/payments/benefits" },
          { label: "История платежей", href: "/demo/medical/user/modules/payments/history" },
          { label: "Долги", href: "/demo/medical/user/modules/payments/debts" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Частые вопросы", href: "/demo/medical/user/modules/support/faq" },
          ...
          { label: "Телефоны", href: "/demo/medical/user/modules/support/phones" },
        ],
      },
    ],
  },
...
const RoleSwitcher = () => {
  ...
  const currentRole = useMemo(() => {
    if (pathname.includes('/owner')) return ROLES[2]; // admin
    if (pathname.includes('/manager')) return ROLES[1]; // manager
    return ROLES[0]; // user
  }, [pathname]);
    ...
    <div className="hidden lg:fixed lg:inset-y-0 lg:z-40 lg:flex lg:w-80 lg:flex-col">
      ...
      >
        ...
        <div className="shrink-0 pt-4">
          <div className="flex h-20 items-center gap-3 mb-4">
            ...
            <div className="flex-1 min-w-0">
              <div className="font-bold text-white/90 text-sm truncate">Пациент</div>
              <div className="text-white/70 text-xs font-medium">Медицинские услуги</div>
            </div>
          </div>
        ...
        <motion.div 
          ...
          whileHover={{ y: -1 }}
          onClick={() => router.push('/demo/medical/user/modules/profile')}
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="text-sm font-semibold text-white/90 truncate">Петров Иван</div>
            <div className="text-xs text-white/70 truncate">Пациент</div>
          </div>
          <motion.span
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-white/70 text-xs">Медицинские услуги</div>
            </div>
          </div>
