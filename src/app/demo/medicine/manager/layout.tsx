...
const DOCTOR_CATEGORIES: Category[] = [
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Отпуск и отгулы", href: "/demo/medical/doctor/modules/schedule/vacation" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Поиск пациента", href: "/demo/medical/doctor/modules/patients/search" },
          { label: "Группы пациентов", href: "/demo/medical/doctor/modules/patients/groups" },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      {
        label: "Диагностические данные",
        href: "/demo/medical/doctor/modules/diagnostics",
        icon: "🔬",
        children: [
          { label: "Результаты анализов", href: "/demo/medical/doctor/modules/diagnostics/test-results" },
          { label: "Направления", href: "/demo/medical/doctor/modules/diagnostics/referrals" },
          { label: "УЗИ и МРТ", href: "/demo/medical/doctor/modules/diagnostics/imaging" },
          { label: "ЭКГ и ЭЭГ", href: "/demo/medical/doctor/modules/diagnostics/ecg-eeg" },
          { label: "Рентген", href: "/demo/medical/doctor/modules/diagnostics/xray" },
          { label: "Лабораторные исследования", href: "/demo/medical/doctor/modules/diagnostics/lab" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Дозировки", href: "/demo/medical/doctor/modules/prescriptions/dosages" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Эффективность лечения", href: "/demo/medical/doctor/modules/reports/treatment-effectiveness" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Клинические случаи", href: "/demo/medical/doctor/modules/education/cases" },
...
const MobileTabbar = () => {
  ...
  const categories = useMemo(() => DOCTOR_CATEGORIES, []);
      ...
      >
        ...
        <div className="shrink-0 pt-4">
          <div className="flex h-20 items-center gap-3 mb-4">
            <motion.div 
              className="w-12 h-12 rounded-2xl bg-gradient-to-br from-green-500 to-emerald-500 flex items-center justify-center shadow-2xl"
            ...
            <div className="flex-1 min-w-0">
              <div className="font-bold text-white/90 text-sm truncate">Доктор Иванова</div>
              <div className="text-white/70 text-xs font-medium">Терапевт</div>
            </div>
          </div>
        ...
        <motion.div 
          ...
          whileHover={{ y: -1 }}
          onClick={() => router.push('/demo/medical/doctor/modules/profile')}
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="text-sm font-semibold text-white/90 truncate">Доктор Иванова</div>
            <div className="text-xs text-white/70 truncate">Терапевт, каб. 214</div>
          </div>
          <motion.span
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-white/70 text-xs">Прием пациентов</div>
            </div>
          </div>
