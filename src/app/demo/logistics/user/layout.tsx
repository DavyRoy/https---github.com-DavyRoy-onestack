...
// Конфигурация меню для клиента доставки
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Новые поступления", href: "/demo/delivery/user/modules/products/new" },
          { label: "Категории товаров", href: "/demo/delivery/user/modules/products/categories" },
          { label: "Избранное", href: "/demo/delivery/user/modules/products/favorites" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Промокоды", href: "/demo/delivery/user/modules/cart/promo" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Возвраты", href: "/demo/delivery/user/modules/payments/refunds" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Условия возврата", href: "/demo/delivery/user/modules/returns/conditions" },
          { label: "Статус возврата", href: "/demo/delivery/user/modules/returns/status" },
          { label: "Обмен товара", href: "/demo/delivery/user/modules/returns/exchange" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Частые вопросы", href: "/demo/delivery/user/modules/support/faq" },
          ...
          { label: "Телефоны поддержки", href: "/demo/delivery/user/modules/support/phones" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Смена роли", href: "/demo/delivery/user/modules/profile/roles" },
        ],
      },
    ],
  },
...
const RoleSwitcher = () => {
  ...
  const currentRole = useMemo(() => {
    ...
    if (pathname.includes('/warehouse')) return ROLES[2]; // warehouse
    ...
    <div className="hidden lg:fixed lg:inset-y-0 lg:z-40 lg:flex lg:w-80 lg:flex-col">
      ...
      >
        ...
        <div className="shrink-0 pt-4">
          <div className="flex h-20 items-center gap-3 mb-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-white/70 text-xs font-medium">Заказы и доставка</div>
            </div>
          </div>
        ...
        <motion.div 
          ...
          whileHover={{ y: -1 }}
          onClick={() => router.push('/demo/delivery/user/modules/profile')}
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="text-sm font-semibold text-white/90 truncate">Иван Сидоров</div>
            <div className="text-xs text-white/70 truncate">Клиент доставки</div>
          </div>
          <motion.span
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-white/70 text-xs">Заказы и доставка</div>
            </div>
          </div>
