      ...
      <div className="mx-auto max-w-7xl px-6 md:px-8 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            <select
              className="bg-white/5 border border-white/10 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
...
function ModulesGrid() {
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 md:px-8 lg:px-8 py-8">
      <h2 className="text-xl font-semibold text-white mb-6">Мои модули</h2>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-1">
                  {module.permissions.user === 'RW' && (
                    <span className="text-xs px-2 py-1 rounded-full bg-green-500/20 text-green-400">
                      Чтение/Запись
                    </span>
                  )}
                  {module.permissions.user === 'R*' && (
...
function ActivityFeed() {
  const activities = [
    { id: 1, type: 'order', message: 'Заказ #2345 передан курьеру', time: '5 мин назад' },
    { id: 2, type: 'delivery', message: 'Доставка #2345 прибыла на склад', time: '2 часа назад' },
    { id: 3, type: 'notification', message: 'Уведомление: изменение времени доставки', time: 'Вчера' },
  ];

  return (
    <section className="mx-auto max-w-7xl px-6 md:px-8 lg:px-8 py-8">
      <h2 className="text-xl font-semibold text-white mb-6">Последние события</h2>
