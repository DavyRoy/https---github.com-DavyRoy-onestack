...
function QuickActions() {
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 md:px-8 lg:px-8 py-8">
      <h2 className="text-xl font-semibold text-white mb-6">Стратегические действия</h2>
...
function ModulesGrid() {
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 md:px-8 lg:px-8 py-8">
      <h2 className="text-xl font-semibold text-white mb-6">Аналитика и управление</h2>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-1">
                  {module.permissions.owner === 'RWD' && (
                    <span className="text-xs px-2 py-1 rounded-full bg-green-500/20 text-green-400">
                      Полный доступ
                    </span>
                  )}
                  {module.permissions.owner === 'RW' && (
                    <span className="text-xs px-2 py-1 rounded-full bg-blue-500/20 text-blue-400">
                      Чтение/Запись
                    </span>
                  )}
                  {module.permissions.owner === 'R' && (
