...
// Конфигурация меню для администратора бизнеса
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Бюджетирование", href: "/demo/delivery/admin/modules/financial/budget" },
          { label: "Налоги и отчетность", href: "/demo/delivery/admin/modules/financial/taxes" },
          { label: "Финансовое планирование", href: "/demo/delivery/admin/modules/financial/planning" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Бизнес-процессы", href: "/demo/delivery/admin/modules/business/processes" },
          ...
          { label: "Риск-менеджмент", href: "/demo/delivery/admin/modules/business/risk" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Оптимизация процессов", href: "/demo/delivery/admin/modules/operations/optimization" },
          { label: "Автоматизация", href: "/demo/delivery/admin/modules/operations/automation" },
          { label: "Стандарты качества", href: "/demo/delivery/admin/modules/operations/quality" },
          { label: "Бизнес-модели", href: "/demo/delivery/admin/modules/operations/models" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Обучение и развитие", href: "/demo/delivery/admin/modules/hr/training" },
          { label: "Кадровый резерв", href: "/demo/delivery/admin/modules/hr/reserve" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        icon: "🎯",
        children: [
          { label: "Маркетинговая стратегия", href: "/demo/delivery/admin/modules/marketing" },
          ...
          { label: "Бренд-менеджмент", href: "/demo/delivery/admin/modules/marketing/brand" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "LTV и удержание", href: "/demo/delivery/admin/modules/customers/ltv" },
          { label: "Сегментация клиентов", href: "/demo/delivery/admin/modules/customers/segmentation" },
          { label: "Лояльность и NPS", href: "/demo/delivery/admin/modules/customers/loyalty" },
          { label: "Воронка продаж", href: "/demo/delivery/admin/modules/customers/funnel" },
          { label: "Прогноз оттока", href: "/demo/delivery/admin/modules/customers/churn" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Кастомизация отчетов", href: "/demo/delivery/admin/modules/reports/custom" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Резервное копирование", href: "/demo/delivery/admin/modules/settings/backup" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        href: "/demo/delivery/admin/modules/development",
        icon: "🚀",
        children: [
          { label: "Стратегия роста", href: "/demo/delivery/admin/modules/development" },
          { label: "Инвестиции и финансирование", href: "/demo/delivery/admin/modules/development/investments" },
          { label: "Масштабирование", href: "/demo/delivery/admin/modules/development/scaling" },
          { label: "Инновации", href: "/demo/delivery/admin/modules/development/innovation" },
          { label: "Партнерские программы", href: "/demo/delivery/admin/modules/development/partnerships" },
          { label: "Бизнес-планирование", href: "/demo/delivery/admin/modules/development/planning" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Безопасность", href: "/demo/delivery/admin/modules/profile/security" },
          { label: "Подписка и тарифы", href: "/demo/delivery/admin/modules/profile/subscription" },
          { label: "Смена роли", href: "/demo/delivery/admin/modules/profile/roles" },
        ],
      },
    ],
  },
...
const RoleSwitcher = () => {
  ...
  const currentRole = useMemo(() => {
    ...
    if (pathname.includes('/warehouse')) return ROLES[3]; // warehouse
    if (pathname.includes('/manager')) return ROLES[2]; // manager
    if (pathname.includes('/courier')) return ROLES[1]; // courier
    return ROLES[0]; // user
  }, [pathname]);
...
const MobileTabbar = () => {
  ...
  const categories = useMemo(() => ADMIN_CATEGORIES, []);
    ...
    <div className="hidden lg:fixed lg:inset-y-0 lg:z-40 lg:flex lg:w-80 lg:flex-col">
      ...
      >
        ...
        <div className="shrink-0 pt-4">
          <div className="flex h-20 items-center gap-3 mb-4">
            ...
            <div className="flex-1 min-w-0">
              <div className="font-bold text-white/90 text-sm truncate">Администратор</div>
        ...
        <motion.div 
          ...
          whileHover={{ y: -1 }}
          onClick={() => router.push('/demo/delivery/admin/modules/profile')}
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="text-xs text-white/70 truncate">Администратор бизнеса</div>
          </div>
          <motion.span
