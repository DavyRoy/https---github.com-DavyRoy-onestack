...
// Конфигурация меню для менеджера доставки
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Оптимизация маршрутов", href: "/demo/delivery/manager/modules/delivery/optimization" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Производительность", href: "/demo/delivery/manager/modules/couriers/performance" },
          { label: "Рейтинги курьеров", href: "/demo/delivery/manager/modules/couriers/ratings" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Лояльность клиентов", href: "/demo/delivery/manager/modules/customers/loyalty" },
          { label: "Рассылки", href: "/demo/delivery/manager/modules/customers/newsletters" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Эффективность доставки", href: "/demo/delivery/manager/modules/analytics/delivery" },
          { label: "Загрузка курьеров", href: "/demo/delivery/manager/modules/analytics/couriers" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Стандарты обслуживания", href: "/demo/delivery/manager/modules/quality/standards" },
          { label: "Аудит процессов", href: "/demo/delivery/manager/modules/quality/audit" },
          { label: "Улучшение сервиса", href: "/demo/delivery/manager/modules/quality/improvement" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Обучение персонала", href: "/demo/delivery/manager/modules/support/training" },
          { label: "База знаний", href: "/demo/delivery/manager/modules/support/knowledge-base" },
          { label: "Эскалация проблем", href: "/demo/delivery/manager/modules/support/escalation" },
        ],
      },
    ],
  },
...
const RoleSwitcher = () => {
  ...
  const currentRole = useMemo(() => {
    if (pathname.includes('/owner')) return ROLES[4]; // admin
    ...
    <div className="hidden lg:fixed lg:inset-y-0 lg:z-40 lg:flex lg:w-80 lg:flex-col">
      ...
      >
        ...
        <motion.div 
          ...
          whileHover={{ y: -1 }}
          onClick={() => router.push('/demo/delivery/manager/modules/profile')}
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="text-xs text-white/70 truncate">Менеджер доставки</div>
          </div>
          <motion.span
