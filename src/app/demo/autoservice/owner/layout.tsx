...
const ROLES = [
  {
    ...
    icon: '👤',
    description: 'Запись и услуги',
    color: 'from-blue-500 to-cyan-500'
  },
  {
    id: 'mechanic',
    label: 'Механик',
    href: '/demo/autoservice/mechanic',
    icon: '🔧',
...
// Конфигурация меню для владельца автосервиса
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Прогнозирование", href: "/demo/autoservice/owner/modules/analytics/forecasting" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Бюджетирование", href: "/demo/autoservice/owner/modules/financial/budget" },
          { label: "Налоги и отчетность", href: "/demo/autoservice/owner/modules/financial/taxes" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Конкурентный анализ", href: "/demo/autoservice/owner/modules/business/competitors" },
          { label: "Риск-менеджмент", href: "/demo/autoservice/owner/modules/business/risk" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Производительность", href: "/demo/autoservice/owner/modules/operations/performance" },
          ...
          { label: "Стандарты качества", href: "/demo/autoservice/owner/modules/operations/quality" },
          { label: "Бизнес-модели", href: "/demo/autoservice/owner/modules/operations/models" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Обучение и развитие", href: "/demo/autoservice/owner/modules/hr/training" },
          { label: "Кадровый резерв", href: "/demo/autoservice/owner/modules/hr/reserve" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "LTV и удержание", href: "/demo/autoservice/owner/modules/customers/ltv" },
          { label: "Сегментация клиентов", href: "/demo/autoservice/owner/modules/customers/segmentation" },
          ...
          { label: "Прогноз оттока", href: "/demo/autoservice/owner/modules/customers/churn" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Бренд-менеджмент", href: "/demo/autoservice/owner/modules/marketing/brand" },
          { label: "Анализ ROI", href: "/demo/autoservice/owner/modules/marketing/roi" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Безопасность", href: "/demo/autoservice/owner/modules/infrastructure/security" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Кастомизация отчетов", href: "/demo/autoservice/owner/modules/reports/custom" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        icon: "🚀",
        children: [
          { label: "Стратегия роста", href: "/demo/autoservice/owner/modules/development" },
          ...
          { label: "Инновации", href: "/demo/autoservice/owner/modules/development/innovation" },
          { label: "Партнерские программы", href: "/demo/autoservice/owner/modules/development/partnerships" },
          { label: "Бизнес-планирование", href: "/demo/autoservice/owner/modules/development/planning" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Резервное копирование", href: "/demo/autoservice/owner/modules/settings/backup" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Настройки безопасности", href: "/demo/autoservice/owner/modules/profile/security" },
          { label: "Подписка и тарифы", href: "/demo/autoservice/owner/modules/profile/subscription" },
          { label: "Смена роли", href: "/demo/autoservice/owner/modules/profile/roles" },
        ],
      },
    ],
  },
...
const RoleSwitcher = () => {
  ...
  const currentRole = useMemo(() => {
    ...
    if (pathname.includes('/mechanic')) return ROLES[1]; // mechanic
    return ROLES[0]; // user
  }, [pathname]);
      ...
      >
        ...
        <div className="shrink-0 pt-4">
          <div className="flex h-20 items-center gap-3 mb-4">
            <motion.div 
              className="w-12 h-12 rounded-2xl bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center shadow-2xl"
        ...
        <motion.div 
          ...
          whileHover={{ y: -1 }}
          onClick={() => router.push('/demo/autoservice/owner/modules/profile')}
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="text-sm font-semibold text-white/90 truncate">Сергей Волков</div>
            <div className="text-xs text-white/70 truncate">Владелец "АвтоПрофи"</div>
          </div>
          <motion.span
