...
// Конфигурация меню для клиента автосервиса
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Диагностика", href: "/demo/autoservice/user/modules/appointments/diagnostics" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Страховка и документы", href: "/demo/autoservice/user/modules/vehicles/documents" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Ремонт двигателя", href: "/demo/autoservice/user/modules/services/engine" },
          { label: "Кузовной ремонт", href: "/demo/autoservice/user/modules/services/body" },
          { label: "Электрика", href: "/demo/autoservice/user/modules/services/electrical" },
          { label: "Шиномонтаж", href: "/demo/autoservice/user/modules/services/tires" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Сметы и расчеты", href: "/demo/autoservice/user/modules/orders/estimates" },
          { label: "Гарантийные работы", href: "/demo/autoservice/user/modules/orders/warranty" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        icon: "🔍",
        children: [
          { label: "Онлайн диагностика", href: "/demo/autoservice/user/modules/diagnostics" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Способы оплаты", href: "/demo/autoservice/user/modules/payments/methods" },
          { label: "Рассрочка и кредит", href: "/demo/autoservice/user/modules/payments/installment" },
          { label: "Страховые случаи", href: "/demo/autoservice/user/modules/payments/insurance" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Акции и скидки", href: "/demo/autoservice/user/modules/spare-parts/discounts" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Частые вопросы", href: "/demo/autoservice/user/modules/support/faq" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Смена роли", href: "/demo/autoservice/user/modules/profile/roles" },
        ],
      },
    ],
  },
    ...
    <div className="hidden lg:fixed lg:inset-y-0 lg:z-40 lg:flex lg:w-80 lg:flex-col">
      ...
      >
        ...
        <div className="shrink-0 pt-4">
          <div className="flex h-20 items-center gap-3 mb-4">
            ...
            <div className="flex-1 min-w-0">
              <div className="font-bold text-white/90 text-sm truncate">Клиент</div>
              <div className="text-white/70 text-xs font-medium">Обслуживание авто</div>
            </div>
          </div>
        ...
        <motion.div 
          ...
          whileHover={{ y: -1 }}
          onClick={() => router.push('/demo/autoservice/user/modules/profile')}
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="text-xs text-white/70 truncate">Владелец BMW X5</div>
          </div>
          <motion.span
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-white/70 text-xs">Обслуживание авто</div>
            </div>
          </div>
