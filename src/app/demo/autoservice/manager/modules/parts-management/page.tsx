...
const PartsManagement = dynamic(() => import('@/modules/autoservice/PartsManagement'), {
      ...
      <div className="mx-auto max-w-7xl px-6 md:px-8 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3 text-sm text-white/60">
            ...
            <span>→</span>
            <span className="text-white">Управление запчастями</span>
          </div>
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div
        ...
        style={{
          backgroundImage:
            'radial-gradient(60% 60% at 80% 20%, rgba(59, 130, 246, 0.08), rgba(0,0,0,0)), radial-gradient(50% 40% at 20% 80%, rgba(139, 92, 246, 0.06), rgba(0,0,0,0))',
        }}
      />
      ...
      <main className="mx-auto max-w-7xl px-6 md:px-8 lg:px-8 py-8">
        ...
        <section className="mb-8">
          ...
          <p className="text-white/60 text-lg">
            Складской учёт, резервирование и контроль остатков запчастей
          </p>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="rounded-2xl bg-white/5 border border-white/10 p-6 text-center">
            <div className="text-2xl font-bold text-blue-400 mb-1">1,248</div>
            <div className="text-white/60 text-sm">Всего SKU</div>
          </div>
          <div className="rounded-2xl bg-white/5 border border-white/10 p-6 text-center">
            <div className="text-2xl font-bold text-green-400 mb-1">856</div>
            <div className="text-white/60 text-sm">В наличии</div>
          </div>
          <div className="rounded-2xl bg-white/5 border border-white/10 p-6 text-center">
            <div className="text-2xl font-bold text-orange-400 mb-1">42</div>
            <div className="text-white/60 text-sm">Мало остатков</div>
          </div>
          <div className="rounded-2xl bg-white/5 border border-white/10 p-6 text-center">
            <div className="text-2xl font-bold text-red-400 mb-1">18</div>
            <div className="text-white/60 text-sm">Нет в наличии</div>
          </div>
        </section>
