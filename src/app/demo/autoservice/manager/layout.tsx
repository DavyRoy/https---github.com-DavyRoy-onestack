...
// Конфигурация меню для менеджера автосервиса
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Архив заказов", href: "/demo/autoservice/manager/modules/orders/archive" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Квалификация", href: "/demo/autoservice/manager/modules/mechanics/qualification" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Лояльные клиенты", href: "/demo/autoservice/manager/modules/customers/loyal" },
          { label: "Рассылки и уведомления", href: "/demo/autoservice/manager/modules/customers/notifications" },
          { label: "Отзывы и рейтинги", href: "/demo/autoservice/manager/modules/customers/reviews" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Нормативы времени", href: "/demo/autoservice/manager/modules/services/timing" },
          { label: "Популярные услуги", href: "/demo/autoservice/manager/modules/services/popular" },
          { label: "Сезонные услуги", href: "/demo/autoservice/manager/modules/services/seasonal" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Списание", href: "/demo/autoservice/manager/modules/warehouse/write-off" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Долги клиентов", href: "/demo/autoservice/manager/modules/finance/debts" },
          { label: "Авансовые платежи", href: "/demo/autoservice/manager/modules/finance/advances" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Гарантийные случаи", href: "/demo/autoservice/manager/modules/quality/warranty" },
          { label: "Рекламации", href: "/demo/autoservice/manager/modules/quality/complaints" },
          { label: "Стандарты обслуживания", href: "/demo/autoservice/manager/modules/quality/standards" },
          { label: "Аудит качества", href: "/demo/autoservice/manager/modules/quality/audit" },
          { label: "Улучшение процессов", href: "/demo/autoservice/manager/modules/quality/improvement" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Эффективность механиков", href: "/demo/autoservice/manager/modules/analytics/mechanics" },
          { label: "Анализ услуг", href: "/demo/autoservice/manager/modules/analytics/services" },
          { label: "KPI и метрики", href: "/demo/autoservice/manager/modules/analytics/kpi" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Смена роли", href: "/demo/autoservice/manager/modules/profile/roles" },
        ],
      },
    ],
  },
...
const RoleSwitcher = () => {
  ...
  const currentRole = useMemo(() => {
    if (pathname.includes('/owner')) return ROLES[3]; // admin
    ...
    <div className="hidden lg:fixed lg:inset-y-0 lg:z-40 lg:flex lg:w-80 lg:flex-col">
      ...
      >
        ...
        <div className="shrink-0 pt-4">
          <div className="flex h-20 items-center gap-3 mb-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-white/70 text-xs font-medium">Управление сервисом</div>
            </div>
          </div>
        ...
        <motion.div 
          ...
          whileHover={{ y: -1 }}
          onClick={() => router.push('/demo/autoservice/manager/modules/profile')}
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="text-xs text-white/70 truncate">Менеджер автосервиса</div>
          </div>
          <motion.span
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-white/70 text-xs">Управление сервисом</div>
            </div>
          </div>
