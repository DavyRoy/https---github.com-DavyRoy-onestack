...
function ProfileHeader() {
  ...
  return (
    <BentoCard className="p-4 sm:p-6 lg:p-8" glowColor={COLORS.green}>
      <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-8">
        ...
        <div className="flex-shrink-0">
          ...
          >
            <div className="w-20 h-20 sm:w-24 sm:h-24 lg:w-32 lg:h-32 rounded-2xl bg-gradient-to-br from-green-500 to-emerald-500 flex items-center justify-center text-white text-2xl sm:text-3xl lg:text-4xl shadow-2xl">
              {profileData.avatar}
            </div>
            <motion.div 
            ...
            >
              <div className="flex items-center gap-3 flex-grow">
                <div className="relative">
                  ...
                  <div className={`absolute -bottom-1 -right-1 w-2 h-2 sm:w-3 sm:h-3 rounded-full ${getStatusColor(member.status)} border-2 border-black`} />
                </div>
...
function PerformanceWidget() {
  const maxEfficiency = Math.max(...performanceMetrics.map(stat => stat.efficiency));
        ...
        <div className="flex-grow space-y-3 sm:space-y-4">
          {performanceMetrics.map((stat, index) => (
            ...
            >
              ...
              <div className="text-center">
                <div className="text-green-400 font-bold text-sm">{stat.efficiency}%</div>
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br ${COLORS.primary}`}>
      <main className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8">
        ...
        >
          <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-white mb-3 sm:mb-4 lg:mb-6">Рабочие показатели</h2>
            ...
            <BentoCard className="p-4 sm:p-6 h-full" glowColor={COLORS.teal}>
              <div className="h-full flex flex-col justify-center items-center text-center">
                ...
                <div className="w-full bg-white/10 rounded-full h-2 sm:h-3 mb-4">
                  <div 
                    className="h-2 sm:h-3 rounded-full bg-gradient-to-r from-teal-500 to-green-500 transition-all duration-1000"
                    style={{ width: '65%' }}
                  />
                </div>
                <div className="text-white/60 text-xs sm:text-sm">
                  Прогресс: 65% • Осталось 3 дня
                </div>
              </div>
            </BentoCard>
          </div>
