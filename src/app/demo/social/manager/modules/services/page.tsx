...
// Данные для категорий услуг менеджера
const managerServiceCategories = [
  {
    id: 'all',
    title: "🛠️ Все услуги",
    description: "Полный каталог услуг • Управление назначениями • Мониторинг эффективности",
    value: "32",
    metric: "Всего услуг",
    color: "#060010",
    ...
    revenue: "2,450,000 ₽",
    growth: "+18%",
    popularServices: ["Социальный патронаж", "Психологические консультации", "Материальная помощь", "Юридические услуги"],
    details: {
      activeServices: 28,
      pendingServices: 3,
      completionRate: 92,
  ...
  },
  {
    ...
    description: "Социальное сопровождение • Патронаж • Реабилитация • Адаптация",
    value: "14",
    metric: "Услуг",
    color: "#060010",
    ...
    revenue: "1,450,000 ₽",
    growth: "+15%",
    popularServices: ["Социальный патронаж", "Сопровождение семей", "Трудовая адаптация", "Реабилитация"],
    details: {
      activeServices: 13,
      pendingServices: 1,
      completionRate: 94,
  ...
  },
  {
    ...
    description: "Финансовая поддержка • Льготы • Компенсации • Целевые выплаты",
    value: "8",
    metric: "Программ",
    color: "#060010",
    ...
    revenue: "800,000 ₽",
    growth: "+25%",
    popularServices: ["Единовременные выплаты", "Компенсации ЖКУ", "Льготы на лечение", "Целевая материальная помощь"],
    details: {
      activeServices: 8,
      pendingServices: 0,
      completionRate: 98,
...
// Данные услуг для менеджера
const managerServicesData = [
  {
    id: 1,
    ...
    managerNotes: "Высокий спрос, требуется расширение штата",
    performance: {
      completionRate: 94,
      clientSatisfaction: 95,
      avgProcessingTime: "2 дня",
      queueLength: 12
    }
  },
  {
    ...
    specialist: "Психолог",
    requirements: "18+ лет",
    managerNotes: "Отличные отзывы, планируется расширение онлайн-формата",
    performance: {
      completionRate: 96,
      clientSatisfaction: 98,
      avgProcessingTime: "1 день",
      queueLength: 8
    }
  },
  {
    id: 3,
    name: "Единовременная материальная помощь",
    ...
    rating: 4.9,
    reviews: 67,
    tags: ["Срочно", "Поддержка", "Финансы", "Льготы"],
    description: "Срочная финансовая поддержка в трудной жизненной ситуации",
    duration: "3-5 дней",
    specialist: "Специалист по соцработе",
    requirements: "Подтверждение трудной ситуации",
    managerNotes: "Высокая востребованность, ограниченный бюджет",
    performance: {
      completionRate: 88,
      clientSatisfaction: 94,
      avgProcessingTime: "4 дня",
      queueLength: 23
    }
  },
  {
    id: 4,
    name: "Компенсация ЖКУ",
    category: "Материальная помощь",
    icon: "🏘️",
    status: "active",
    price: "до 50%",
    ...
    rating: 4.7,
    reviews: 92,
    tags: ["Льготы", "ЖКХ", "Компенсация", "Регулярно"],
    description: "Компенсация расходов на жилищно-коммунальные услуги",
    duration: "Ежемесячно",
    specialist: "Специалист по льготам",
    requirements: "Льготная категория",
    managerNotes: "Стабильная программа, требует регулярного обновления документов",
    performance: {
      completionRate: 95,
      clientSatisfaction: 92,
      avgProcessingTime: "7 дней",
      queueLength: 15
    }
  },
  {
    ...
    managerNotes: "Необходимо увеличить количество специалистов",
    performance: {
      completionRate: 90,
      clientSatisfaction: 91,
      avgProcessingTime: "3 дня",
      queueLength: 18
    }
  },
  {
    id: 6,
    name: "Целевая материальная помощь",
    category: "Материальная помощь",
    icon: "🎯",
    status: "development",
    price: "до 25,000 ₽",
    ...
    rating: 4.8,
    reviews: 23,
    tags: ["Целевая", "Поддержка", "Развитие", "Образование"],
    description: "Целевая финансовая поддержка для образования, лечения, развития",
    duration: "10-15 дней",
    specialist: "Координатор программ",
    requirements: "Целевое назначение",
    managerNotes: "Новая программа, требует продвижения",
    performance: {
      completionRate: 85,
      clientSatisfaction: 93,
      avgProcessingTime: "12 дней",
      queueLength: 5
    }
  }
];

const managerServiceMetrics = [
  { category: "Всего услуг", value: "32", trend: "up", color: "#3B82F6", icon: "📊" },
  { category: "Активных услуг", value: "28", trend: "stable", color: "#10B981", icon: "✅" },
  { category: "Средний рейтинг", value: "4.7/5", trend: "up", color: "#F59E0B", icon: "⭐" },
  { category: "Клиентов в месяц", value: "1,856", trend: "up", color: "#8B5CF6", icon: "👥" },
  { category: "Выполнение в срок", value: "92%", trend: "up", color: "#06B6D4", icon: "⏱️" },
  { category: "Доход в месяц", value: "2.45M ₽", trend: "up", color: "#84CC16", icon: "💰" }
];
...
const serviceDistribution = [
  { name: "Социальные услуги", value: 44, color: `rgba(${COLORS.purple}, 0.8)` },
  { name: "Материальная помощь", value: 25, color: `rgba(${COLORS.emerald}, 0.8)` },
  { name: "Медицинские услуги", value: 15, color: `rgba(${COLORS.rose}, 0.8)` },
  { name: "Юридические услуги", value: 9, color: `rgba(${COLORS.amber}, 0.8)` },
  { name: "Образовательные", value: 7, color: `rgba(${COLORS.blue}, 0.8)` }
];

export default function ManagerServicesCatalog() {
  ...
  const filteredServices = managerServicesData.filter(service => {
    const matchesSearch = service.name.toLowerCase().includes(searchTerm.toLowerCase()) ||
                         service.category.toLowerCase().includes(searchTerm.toLowerCase()) ||
                         service.tags.some((tag: string) => tag.toLowerCase().includes(searchTerm.toLowerCase()));
    const matchesStatus = filterStatus === 'all' || service.status === filterStatus;
    const matchesCategory = selectedCategory === 'all' || service.category === managerServiceCategories.find(c => c.id === selectedCategory)?.title;
    
    return matchesSearch && matchesStatus && matchesCategory;
  });

  const selectedCategoryData = managerServiceCategories.find(cat => cat.id === selectedCategory);
        ...
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <span className="text-white text-sm">Услуги активны • 92% выполнение в срок</span>
            </div>
          </div>
        </div>
      </motion.header>
      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-6">
          ...
          <div className="card--border-glow relative overflow-hidden rounded-2xl sm:rounded-3xl border border-white/10 bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-lg p-4 sm:p-6 md:p-8">
            <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 sm:gap-6">
              <div className="flex-1">
                ...
                >
                  <span className="text-emerald-400">32 социальные услуги</span> • 3 основных направления • <span className="text-blue-400">92% выполнение в срок</span>
                </motion.p>
                <motion.div 
                ...
                >
                  <div className="flex items-center gap-2 text-white/70 text-xs sm:text-sm">
                    ...
                    <span>28 активных услуг</span>
                  </div>
                  <div className="flex items-center gap-2 text-white/70 text-xs sm:text-sm">
                    <div className="w-2 h-2 rounded-full bg-blue-400" />
                    <span>1,856 клиентов в месяц</span>
                  </div>
                  <div className="flex items-center gap-2 text-white/70 text-xs sm:text-sm">
                    <div className="w-2 h-2 rounded-full bg-purple-400" />
                    <span>Средний рейтинг 4.7/5</span>
                  </div>
                </motion.div>
              </div>
              <motion.div 
        ...
        >
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-3 md:gap-4">
            {managerServiceMetrics.map((metric, index) => (
              <motion.div
                key={index}
        ...
        {/* Bento Grid с категориями услуг */}
        <GlobalSpotlight
          gridRef={gridRef}
        ...
        <BentoCardGrid gridRef={gridRef} className="mb-6 sm:mb-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
            {managerServiceCategories.map((category, index) => {
                ...
                >
                  ...
                  <div className="card__content flex flex-col relative text-white z-10 flex-1">
                    ...
                    <div className="mt-auto">
                      ...
                      <div className="flex flex-wrap gap-1">
                        {category.popularServices.slice(0, isMobile ? 2 : 3).map((service, serviceIndex) => (
                          <motion.span 
                            key={serviceIndex}
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2 sm:gap-4 mb-3 sm:mb-4">
                    <div className="text-center p-2 sm:p-3 bg-white/5 rounded-lg">
                      <div className="text-white font-bold text-base sm:text-lg">{selectedCategoryData.details.activeServices}</div>
                    ...
                    <div className="text-center p-2 sm:p-3 bg-white/5 rounded-lg">
                      <div className="text-white font-bold text-xs sm:text-sm">{selectedCategoryData.details.pendingServices}</div>
                      <div className="text-white/60 text-xs">В разработке</div>
                    </div>
                  </div>
                  ...
                  <div className="p-2 sm:p-3 bg-green-500/10 rounded-lg border border-green-500/20">
                    ...
                    <div className="text-green-400/60 text-xs mt-1">
                      +{selectedCategoryData.details.clientSatisfaction - 89}% к общей удовлетворенности
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="card--border-glow relative overflow-hidden rounded-xl sm:rounded-2xl border border-white/10 bg-white/5 backdrop-blur-lg p-4 sm:p-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 sm:mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
                <input
                  type="text"
                  placeholder="Поиск по услуге, категории..."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
            ...
            <div className="card--border-glow relative overflow-hidden rounded-xl sm:rounded-2xl border border-white/10 bg-white/5 backdrop-blur-lg p-4 sm:p-6">
              ...
              <div className="flex items-center justify-center mb-4 sm:mb-6">
                <PieChart data={serviceDistribution} size={isMobile ? 100 : 140} />
              </div>
              <div className="space-y-1 sm:space-y-2">
                {serviceDistribution.map((category, index) => (
            ...
            <div className="card--border-glow relative overflow-hidden rounded-xl sm:rounded-2xl border border-white/10 bg-white/5 backdrop-blur-lg p-4 sm:p-6">
              ...
              <div className="space-y-2 sm:space-y-3">
                <motion.div 
                  ...
                  whileHover={{ scale: isMobile ? 1 : 1.02 }}
                >
                  <div className="text-blue-400 font-bold text-xs sm:text-sm">92% выполнение</div>
                  <div className="text-blue-400/60 text-xs">Услуг в срок</div>
                  <ProgressBar value={92} color="#3B82F6" showLabel={false} height="4px" />
                </motion.div>
                <motion.div 
                  className="p-2 sm:p-3 bg-green-500/10 rounded-lg border border-green-500/20 hover:bg-green-500/15 transition-colors"
                  whileHover={{ scale: isMobile ? 1 : 1.02 }}
                >
                  <div className="text-green-400 font-bold text-xs sm:text-sm">89% удовлетворенность</div>
                  <div className="text-green-400/60 text-xs">Клиентов услугами</div>
                  <ProgressBar value={89} color="#10B981" showLabel={false} height="4px" />
                </motion.div>
                <motion.div 
                  className="p-2 sm:p-3 bg-amber-500/10 rounded-lg border border-amber-500/20 hover:bg-amber-500/15 transition-colors"
                  whileHover={{ scale: isMobile ? 1 : 1.02 }}
                >
                  <div className="text-amber-400 font-bold text-xs sm:text-sm">78% загрузка</div>
                  <div className="text-amber-400/60 text-xs">Мощностей услуг</div>
                  <ProgressBar value={78} color="#F59E0B" showLabel={false} height="4px" />
                </motion.div>
              </div>
            </div>
          ...
          >
            ...
            >
              ...
              <div className="p-4 sm:p-6 overflow-y-auto max-h-[50vh] sm:max-h-[60vh]">
                ...
                <div className="mb-4 sm:mb-6">
                  <h3 className="text-base sm:text-lg font-semibold text-white mb-2 sm:mb-3">📊 Показатели эффективности</h3>
                  <div className="grid grid-cols-2 gap-2 sm:gap-3">
                    <div className="bg-white/5 rounded-lg p-2 sm:p-3">
                      <div className="text-white/60 text-xs mb-1">Выполнение в срок</div>
                      <div className="text-white font-semibold text-sm sm:text-base">{selectedService.performance.completionRate}%</div>
                    </div>
                    <div className="bg-white/5 rounded-lg p-2 sm:p-3">
                      <div className="text-white/60 text-xs mb-1">Удовлетворенность</div>
                      <div className="text-white font-semibold text-sm sm:text-base">{selectedService.performance.clientSatisfaction}%</div>
                    </div>
                    <div className="bg-white/5 rounded-lg p-2 sm:p-3">
                      <div className="text-white/60 text-xs mb-1">Среднее время</div>
                      <div className="text-white font-semibold text-sm sm:text-base">{selectedService.performance.avgProcessingTime}</div>
                    </div>
                    <div className="bg-white/5 rounded-lg p-2 sm:p-3">
                      <div className="text-white/60 text-xs mb-1">В очереди</div>
                      <div className="text-white font-semibold text-sm sm:text-base">{selectedService.performance.queueLength}</div>
                    </div>
                  </div>
                </div>
                
                <div className="mb-4 sm:mb-6">
                  <div className="text-white/60 text-xs mb-1 sm:mb-2">Примечания менеджера</div>
                  <div className="text-white font-semibold text-sm sm:text-base">{selectedService.managerNotes}</div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-2 sm:gap-4 text-white/60 text-xs sm:text-sm">
            <div className="flex items-center gap-2 sm:gap-4 flex-wrap justify-center">
              <span>© 2024 Управление услугами "Забота"</span>
            ...
            <div className="flex items-center gap-2 sm:gap-4 flex-wrap justify-center">
              ...
              <span>•</span>
              <span>92% выполнение в срок</span>
            </div>
          </div>
        </div>
      </motion.footer>
