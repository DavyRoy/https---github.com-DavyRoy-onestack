        ...
        <div className="space-y-4">
          {filteredArticles.map((article) => (
            <motion.div
              ...
              whileHover={{ y: -2 }}
            >
              <h4 className="font-semibold text-white text-sm mb-2">{article.title}</h4>
              ...
              <div className="flex flex-wrap gap-2 justify-between items-center">
                ...
                <div className="text-white/40 text-xs">
                  {article.views} просмотров • {formatDate(article.lastUpdated)}
                </div>
              </div>
            </motion.div>
          ))}
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex justify-between items-center text-xs text-white/40">
                    ...
                    <span>{specialist.currentChats} чатов</span>
                  </div>
                </div>
              </div>
            </motion.div>
        ...
        <div className="max-w-7xl 2xl:max-w-[1800px] mx-auto px-3 sm:px-4 py-2 sm:py-3">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-0">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              />
              <span className="text-white text-xs sm:text-sm">Поддержка онлайн</span>
            </div>
          </div>
        </div>
      </motion.header>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 sm:gap-8">
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="card--border-glow relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-lg p-4 sm:p-6 lg:p-8">
                  ...
                  <div className="space-y-3">
                    {supportSpecialists.filter(s => s.isOnline).slice(0, 3).map((specialist) => (
                      <motion.div
                        key={specialist.id}
                        className="flex items-center gap-3 p-3 bg-white/5 rounded-lg border border-white/5 hover:border-white/20 transition-all duration-300"
                        whileHover={{ y: -2 }}
                      >
                        <div className="relative">
                ...
                <div className="card--border-glow relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-lg p-4 sm:p-6 lg:p-8">
                  ...
                  <div className="space-y-3">
                    <div className="text-center">
                      <div className="text-2xl text-white font-bold mb-2">8-800-555-35-35</div>
                      <div className="text-white/60 text-sm mb-4">Бесплатно по России</div>
                      <button className="w-full bg-green-500 hover:bg-green-600 text-white py-3 rounded-xl font-medium transition-colors duration-300 mb-2">
                        📞 Позвонить сейчас
                      </button>
                    </div>
                    ...
                    <div className="text-center text-white/60 text-sm">
                      ...
                      <div>Telegram: @companysupport</div>
                      <div>Часы работы: 24/7</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="bg-white/5 rounded-2xl p-4 sm:p-6 border border-white/10">
                  <h3 className="text-white font-semibold mb-3">Статус поддержки</h3>
                  <div className="space-y-3">
                    <div className="flex justify-between text-sm">
                      <span className="text-white/60">Онлайн специалистов:</span>
                      <span className="text-green-400">{stats.activeSupport}</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-white/60">Среднее время ответа:</span>
                      <span className="text-blue-400">{stats.averageResponseTime}</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-white/60">Решено сегодня:</span>
                      <span className="text-purple-400">{stats.resolvedToday}</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-white/60">Удовлетворенность:</span>
                      <span className="text-cyan-400">{stats.satisfactionRate}%</span>
                    </div>
                  </div>
                </div>
                
                <div className="bg-white/5 rounded-2xl p-4 sm:p-6 border border-white/10">
                  <h3 className="text-white font-semibold mb-3">Полезные ссылки</h3>
                  <div className="space-y-2">
                    {[
                      { label: 'База знаний', icon: '📚' },
                      { label: 'Видеоуроки', icon: '🎥' },
                      { label: 'Сообщество', icon: '👥' },
                      { label: 'Блог', icon: '📝' }
                    ].map((link, index) => (
                      <motion.button
                        key={index}
                        className="w-full flex items-center gap-3 p-2 text-white/60 hover:text-white transition-colors text-sm"
                        whileHover={{ x: 4 }}
                      >
                        <span>{link.icon}</span>
        ...
        <div className="max-w-7xl 2xl:max-w-[1800px] mx-auto px-3 sm:px-4 py-4 sm:py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-2 sm:gap-4 text-white/60 text-xs sm:text-sm">
            <div className="flex flex-col sm:flex-row items-center gap-1 sm:gap-4 text-center sm:text-left">
              <span>© 2024 Центр поддержки</span>
              <span className="hidden sm:inline">•</span>
              <span className="hidden sm:inline">Круглосуточная помощь</span>
            </div>
