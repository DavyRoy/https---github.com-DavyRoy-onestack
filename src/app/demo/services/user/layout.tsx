...
// Конфигурация меню для клиента сферы услуг
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "IT и технологии", href: "/demo/services/user/modules/categories/it" },
          { label: "Дом и быт", href: "/demo/services/user/modules/categories/home" },
          { label: "Транспорт", href: "/demo/services/user/modules/categories/transport" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Срочные услуги", href: "/demo/services/user/modules/booking/urgent" },
          { label: "Повторная запись", href: "/demo/services/user/modules/booking/repeat" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Рейтинги и отзывы", href: "/demo/services/user/modules/specialists/ratings" },
          { label: "Избранные", href: "/demo/services/user/modules/specialists/favorites" },
          { label: "Поиск по специализации", href: "/demo/services/user/modules/specialists/specialization" },
          { label: "Онлайн консультации", href: "/demo/services/user/modules/specialists/consultations" },
          { label: "Портфолио", href: "/demo/services/user/modules/specialists/portfolio" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Предоплата", href: "/demo/services/user/modules/payments/prepayment" },
          { label: "Рассрочка", href: "/demo/services/user/modules/payments/installment" },
          { label: "Возвраты", href: "/demo/services/user/modules/payments/refunds" },
    ...
    items: [
      {
        ...
        href: "/demo/services/user/modules/reviews",
        icon: "⭐",
        children: [
          { label: "Мои отзывы", href: "/demo/services/user/modules/reviews" },
          { label: "Оставить отзыв", href: "/demo/services/user/modules/reviews/new" },
          { label: "Рейтинги специалистов", href: "/demo/services/user/modules/reviews/ratings" },
          { label: "Фотоотчеты", href: "/demo/services/user/modules/reviews/photos" },
          { label: "Рекомендации", href: "/demo/services/user/modules/reviews/recommendations" },
          { label: "Жалобы", href: "/demo/services/user/modules/reviews/complaints" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        href: "/demo/services/user/modules/support",
        icon: "🤝",
        children: [
          { label: "Центр поддержки", href: "/demo/services/user/modules/support" },
          { label: "Частые вопросы", href: "/demo/services/user/modules/support/faq" },
          { label: "Онлайн-чат", href: "/demo/services/user/modules/support/chat" },
          { label: "Обратная связь", href: "/demo/services/user/modules/support/feedback" },
          { label: "Контакты", href: "/demo/services/user/modules/support/contacts" },
          { label: "Правила сервиса", href: "/demo/services/user/modules/support/rules" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Смена роли", href: "/demo/services/user/modules/profile/roles" },
        ],
      },
    ],
  },
    ...
    <div className="hidden lg:fixed lg:inset-y-0 lg:z-40 lg:flex lg:w-80 lg:flex-col">
      ...
      >
        ...
        <div className="shrink-0 pt-4">
          <div className="flex h-20 items-center gap-3 mb-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-white/70 text-xs font-medium">Поиск и заказ услуг</div>
            </div>
          </div>
        ...
        <motion.div 
          ...
          whileHover={{ y: -1 }}
          onClick={() => router.push('/demo/services/user/modules/profile')}
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="text-sm font-semibold text-white/90 truncate">Мария Иванова</div>
            <div className="text-xs text-white/70 truncate">Клиент сервиса услуг</div>
          </div>
          <motion.span
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-white/70 text-xs">Поиск и заказ услуг</div>
            </div>
          </div>
