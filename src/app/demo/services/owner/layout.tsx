...
// Конфигурация меню для владельца бизнеса сферы услуг
    ...
    items: [
      {
        ...
        icon: "💰",
        children: [
          { label: "Финансовая аналитика", href: "/demo/services/owner/modules/finance" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Бенчмаркинг", href: "/demo/services/owner/modules/analytics/benchmarking" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Обучение и развитие", href: "/demo/services/owner/modules/personnel/training" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Автоматизация", href: "/demo/services/owner/modules/operations/automation" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Инновации", href: "/demo/services/owner/modules/strategy/innovation" },
          { label: "Управление рисками", href: "/demo/services/owner/modules/strategy/risks" },
          { label: "Слияния и поглощения", href: "/demo/services/owner/modules/strategy/m&a" },
          { label: "Выход на новые рынки", href: "/demo/services/owner/modules/strategy/new-markets" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Анализ ROI", href: "/demo/services/owner/modules/investments/roi" },
          { label: "Франчайзинг", href: "/demo/services/owner/modules/investments/franchising" },
          ...
          { label: "Развитие активов", href: "/demo/services/owner/modules/investments/assets" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Аудиторские проверки", href: "/demo/services/owner/modules/reports/audit" },
          { label: "Документооборот", href: "/demo/services/owner/modules/reports/documents" },
          { label: "Архив отчетов", href: "/demo/services/owner/modules/reports/archive" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Безопасность", href: "/demo/services/owner/modules/settings/security" },
    ...
    <div className="hidden lg:fixed lg:inset-y-0 lg:z-40 lg:flex lg:w-80 lg:flex-col">
      ...
      >
        ...
        <div className="shrink-0 pt-4">
          <div className="flex h-20 items-center gap-3 mb-4">
            ...
            <div className="flex-1 min-w-0">
              <div className="font-bold text-white/90 text-sm truncate">Владелец бизнеса</div>
              <div className="text-white/70 text-xs font-medium">Стратегическое управление</div>
            </div>
          </div>
        ...
        <motion.div 
          ...
          whileHover={{ y: -1 }}
          onClick={() => router.push('/demo/services/owner/modules/profile')}
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="text-sm font-semibold text-white/90 truncate">Александр Петров</div>
            <div className="text-xs text-white/70 truncate">Владелец бизнеса услуг</div>
          </div>
          <motion.span
      ...
      <div className="flex items-center justify-between px-4 h-16">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs text-white/70">Стратегическое управление</div>
          </div>
        </div>
