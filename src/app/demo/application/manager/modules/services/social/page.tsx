...
// Данные для социальных услуг менеджера
const socialServicesData = [
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 67,
    tags: ["Семейный", "Поддержка", "Консультации", "Дети"],
    description: "Профессиональное сопровождение семей в трудной жизненной ситуации",
    duration: "3-6 месяцев",
    specialist: "Семейный психолог",
    requirements: "Наличие детей",
    managerStats: {
      assignedClients: 32,
      completionRate: 88,
      satisfaction: 91,
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 45,
    tags: ["Реабилитация", "Восстановление", "Терапия", "Поддержка"],
    description: "Комплексные программы социальной и психологической реабилитации",
  ...
  },
  {
    ...
    rating: 4.6,
    reviews: 23,
    tags: ["Труд", "Адаптация", "Обучение", "Карьера"],
    description: "Программы по трудовой адаптации и профессиональной ориентации",
    duration: "3-9 месяцев",
    specialist: "Карьерный консультант",
    requirements: "Трудоспособный возраст",
    managerStats: {
      assignedClients: 15,
      completionRate: 78,
      satisfaction: 89,
  ...
  },
  {
    ...
    rating: 4.5,
    reviews: 56,
    tags: ["Интеграция", "Социализация", "Общество", "Поддержка"],
    description: "Программы по интеграции в общество и развитие социальных навыков",
    duration: "4-8 месяцев",
    specialist: "Социальный педагог",
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 34,
    tags: ["Кризис", "Срочно", "Поддержка", "Экстренно"],
    description: "Экстренная социальная поддержка в кризисных ситуациях",
    duration: "1-3 месяца",
...
const managerMetrics = [
  { category: "Всего клиентов", value: "160", trend: "up", color: "#3B82F6", icon: "👥" },
  ...
  { category: "Выполнение плана", value: "87%", trend: "up", color: "#8B5CF6", icon: "📊" },
  { category: "Доход в месяц", value: "1.27M ₽", trend: "up", color: "#84CC16", icon: "💰" },
...
const upcomingTasks = [
  ...
  {
    id: 4,
    title: "Разработка новых программ",
    deadline: "2024-02-01",
    priority: "medium",
    assigned: "Мария Козлова",
    progress: 45
  }
];
...
export default function SocialServicesManager() {
  ...
  const totalRevenue = socialServicesData.reduce((sum, service) => {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br ${COLORS.primary}`}>
      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-6">
        {/* Заголовок страницы для менеджера */}
        <motion.section 
          ...
          <div className="card--border-glow relative overflow-hidden rounded-2xl sm:rounded-3xl border border-white/10 bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-lg p-4 sm:p-6 md:p-8">
            <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 sm:gap-6">
              <div className="flex-1">
                ...
                >
                  <span className="text-emerald-400">6 социальных услуг</span> • <span className="text-blue-400">160 клиентов</span> • <span className="text-purple-400">5 специалистов в команде</span>
                </motion.p>
                <motion.div 
              ...
              >
                ...
                <div className="text-white/60 text-xs sm:text-sm mt-1 sm:mt-2">Иванов А.С.</div>
            ...
            <div className="absolute bottom-0 left-0 w-16 h-16 sm:w-24 sm:h-24 bg-gradient-to-tr from-emerald-500/10 to-green-500/10 rounded-full blur-lg" />
          </div>
        </motion.section>
          ...
          >
                    ...
                    {socialServicesData.map((service, index) => (
                      ...
                      >
                        <div className="card__header flex justify-between items-start gap-2 sm:gap-3 relative text-white z-10">
                          ...
                          >
                            {service.managerStats.assignedClients} клиентов
                          </span>
                          <motion.div 
                          ...
                          <div className="space-y-2 sm:space-y-3 mb-3 sm:mb-4 flex-1">
                            <div className="grid grid-cols-2 gap-2 text-xs">
                              <div className="text-center p-2 bg-white/5 rounded-lg">
                                <div className="text-white font-bold">{service.managerStats.completionRate}%</div>
                                <div className="text-white/60">Выполнение</div>
                              </div>
                              <div className="text-center p-2 bg-white/5 rounded-lg">
            ...
            {activeTab === 'team' && (
              <div className="card--border-glow relative overflow-hidden rounded-xl sm:rounded-2xl border border-white/10 bg-white/5 backdrop-blur-lg p-4 sm:p-6">
                <h2 className="text-lg sm:text-xl font-bold text-white mb-4 sm:mb-6">👥 Команда специалистов</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                  {teamPerformance.map((member, index) => (
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between text-white text-xs">
                          <span>Клиентов</span>
                          <span className="font-bold">{member.clients}</span>
                        </div>
            ...
            {activeTab === 'tasks' && (
              <div className="card--border-glow relative overflow-hidden rounded-xl sm:rounded-2xl border border-white/10 bg-white/5 backdrop-blur-lg p-4 sm:p-6">
                <h2 className="text-lg sm:text-xl font-bold text-white mb-4 sm:mb-6">✅ Текущие задачи</h2>
                    ...
                    >
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-white/60 text-xs">
                          {task.assigned} • До {new Date(task.deadline).toLocaleDateString('ru-RU')}
                        </div>
            ...
            {activeTab === 'reports' && (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                    ...
                    {socialServicesData.map((service, index) => (
                      <div key={service.id} className="flex items-center justify-between p-2 sm:p-3 bg-white/5 rounded-lg">
                        ...
                        <div className="text-right ml-2">
                          ...
                          <div className="text-white/60 text-xs">{service.managerStats.assignedClients} клиентов</div>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div className="card--border-glow relative overflow-hidden rounded-xl sm:rounded-2xl border border-white/10 bg-white/5 backdrop-blur-lg p-4 sm:p-6">
                  <h3 className="text-base sm:text-lg font-bold text-white mb-3 sm:mb-4">📊 KPI отдела</h3>
                  <div className="space-y-4">
                    <div>
                      <div className="flex justify-between text-white text-sm mb-2">
                        <span>Общее выполнение плана</span>
                        <span>87%</span>
                      </div>
                      <ProgressBar value={87} color="#3B82F6" height="6px" />
                    </div>
                    <div>
                      <div className="flex justify-between text-white text-sm mb-2">
                      ...
                      <ProgressBar value={93} color="#10B981" height="6px" />
                    </div>
                    <div>
                      <div className="flex justify-between text-white text-sm mb-2">
                      ...
                      <ProgressBar value={89} color="#8B5CF6" height="6px" />
                    </div>
                    <div>
                      <div className="flex justify-between text-white text-sm mb-2">
                      ...
                      <ProgressBar value={91} color="#F59E0B" height="6px" />
                    </div>
                  </div>
                </div>
              </div>
      ...
      {/* Модальное окно деталей услуги для менеджера */}
      <AnimatePresence>
            ...
            >
              ...
              <div className="p-4 sm:p-6 overflow-y-auto max-h-[50vh] sm:max-h-[60vh]">
                <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6">
                  ...
                  <div className="text-center p-2 sm:p-3 md:p-4 bg-white/5 rounded-lg sm:rounded-xl">
                    <div className="text-lg sm:text-xl md:text-2xl font-bold text-white mb-1 sm:mb-2">{selectedService.managerStats.assignedClients}</div>
                    <div className="text-white/60 text-xs sm:text-sm">Клиентов</div>
                  </div>
                </div>
                
                <div className="mb-4 sm:mb-6">
                  <h3 className="text-base sm:text-lg font-semibold text-white mb-2 sm:mb-3">Статистика менеджера</h3>
                  <div className="grid grid-cols-2 gap-3 sm:gap-4">
                    <div className="bg-white/5 rounded-lg p-2 sm:p-3">
                      <div className="text-white/60 text-xs mb-1">Выполнение</div>
                      <div className="text-white font-semibold text-sm sm:text-base">{selectedService.managerStats.completionRate}%</div>
                    </div>
                    <div className="bg-white/5 rounded-lg p-2 sm:p-3">
              ...
              <div className="p-4 sm:p-6 border-t border-white/10">
                <div className="flex gap-3">
                  <motion.button
                    className="flex-1 bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 sm:py-3 rounded-lg sm:rounded-xl transition-colors text-sm sm:text-base"
