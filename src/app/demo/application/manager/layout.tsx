...
// Расширенная конфигурация меню для менеджера
const MANAGER_CATEGORIES: Category[] = [
    ...
    items: [
      {
        ...
        href: "/demo/application/manager/modules/requests",
        icon: "📋",
        description: "Обработка всех заявок",
        featured: true,
        children: [
          { 
            label: "Все заявки", 
            href: "/demo/application/manager/modules/requests",
            description: "Полный список заявок",
            badge: 156,
            icon: "📄"
          },
          { 
            label: "Новые заявки", 
            href: "/demo/application/manager/modules/requests/new",
          ...
          { 
            label: "В работе", 
            href: "/demo/application/manager/modules/requests/in-progress",
  ...
  },
  {
    ...
    items: [
      {
        label: "База клиентов",
        href: "/demo/application/manager/modules/citizens",
        icon: "👥",
        ...
        children: [
          { 
            label: "Граждане", 
            href: "/demo/application/manager/modules/clients/social",
          ...
          { 
            label: "Пациенты", 
            href: "/demo/application/manager/modules/clients/medical",
          ...
          { 
            label: "Курьеры", 
            href: "/demo/application/manager/modules/clients/delivery",
          ...
          { 
            label: "Пассажиры", 
            href: "/demo/application/manager/modules/clients/transport",
          ...
          { 
            label: "Автовладельцы", 
            href: "/demo/application/manager/modules/clients/autoservice",
          ...
          { 
            label: "Клиенты", 
            href: "/demo/application/manager/modules/clients/services",
  ...
  },
  {
    ...
    items: [
      {
        label: "Каталог услуг",
        href: "/demo/application/manager/modules/services",
        icon: "🎯",
        ...
        children: [
          { 
            ...
            href: "/demo/application/manager/modules/services/social",
          ...
          { 
            ...
            href: "/demo/application/manager/modules/services/medical",
          ...
          { 
            ...
            href: "/demo/application/manager/modules/services/delivery",
          ...
          { 
            ...
            href: "/demo/application/manager/modules/services/transport",
          ...
          { 
            ...
            href: "/demo/application/manager/modules/services/autoservice",
          ...
          { 
            ...
            href: "/demo/application/manager/modules/services/services",
    ...
    items: [
      {
        ...
        href: "/demo/application/manager/modules/personnel",
        icon: "👨‍⚕️",
        description: "Сотрудники и волонтеры",
        children: [
          { 
            label: "Волонтёры", 
            href: "/demo/application/manager/modules/personnel/social",
          ...
          { 
            label: "Врачи", 
            href: "/demo/application/manager/modules/personnel/medical",
          ...
          { 
            label: "Курьеры", 
            href: "/demo/application/manager/modules/personnel/delivery",
            description: "Служба доставки",
            badge: 12,
            icon: "🚴"
          },
          { 
            label: "Водители", 
            href: "/demo/application/manager/modules/personnel/transport",
          ...
          { 
            label: "Механики", 
            href: "/demo/application/manager/modules/personnel/autoservice",
            description: "Автосервис",
            badge: 6,
            icon: "🔧"
          },
          { 
            label: "Специалисты", 
            href: "/demo/application/manager/modules/personnel/services",
    ...
    items: [
      {
        ...
        href: "/demo/application/manager/modules/daily",
        icon: "📈",
        ...
        children: [
          { 
            ...
            href: "/demo/application/manager/modules/daily",
            description: "Операционные отчеты",
            badge: "New",
            icon: "📊"
          },
        ],
    ...
    items: [
      {
        ...
        href: "/demo/application/manager/modules/profile",
        icon: "👨‍💼",
...
const DesktopSidebar = () => {
  ...
  const filteredCategories = useMemo(() => {
    if (!searchQuery) return MANAGER_CATEGORIES;
    
    return MANAGER_CATEGORIES.map(category => ({
      ...category,
    ...
    <div className="hidden lg:fixed lg:inset-y-0 lg:z-40 lg:flex lg:w-80 lg:flex-col">
      ...
      >
        ...
        <div className="shrink-0 pt-4">
          <div className="flex h-20 items-center gap-3 mb-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-white/70 text-xs font-medium">Управление социальными услугами</div>
            </div>
          </div>
        ...
        <motion.div 
          ...
          whileHover={{ y: -1 }}
          onClick={() => router.push('/demo/application/manager/modules/profile')}
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="text-sm font-semibold text-white/90 truncate">Петрова Мария</div>
            <div className="text-xs text-white/70 truncate">Менеджер социальных услуг</div>
          </div>
          <motion.span
