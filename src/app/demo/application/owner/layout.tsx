...
// Конфигурация ролей для социальных услуг
const ROLES = [
  {
    id: 'user',
    label: 'Клиент',
...
// Расширенная конфигурация меню для владельца социальных услуг
const OWNER_CATEGORIES: Category[] = [
  {
    ...
    items: [
      { 
        ...
        icon: "📊",
        featured: true,
        description: "Обзор всех показателей"
      }
    ],
  },
  {
    ...
    items: [
      {
        ...
        href: "/demo/application/owner/modules/organization",
        icon: "🏛️",
        description: "Управление всеми подразделениями",
        badge: "New",
        children: [
          { 
            label: "Социальная организация", 
            href: "/demo/application/owner/modules/organization/social",
            description: "Основное подразделение",
            badge: 12
          },
          { 
            label: "Клиника", 
            href: "/demo/application/owner/modules/organization/medical",
            description: "Медицинские услуги",
            badge: 8
          },
          { 
            label: "Склад", 
            href: "/demo/application/owner/modules/organization/delivery",
            description: "Логистика и доставка",
            badge: 5
          },
          { 
            label: "Автопарк", 
            href: "/demo/application/owner/modules/organization/transport",
            description: "Транспортные средства",
            badge: 23
          },
          { 
            label: "Автосервис", 
            href: "/demo/application/owner/modules/organization/autoservice",
            description: "Техническое обслуживание",
            badge: 7
          },
          { 
            label: "Предприятие", 
            href: "/demo/application/owner/modules/organization/services",
            description: "Коммерческие услуги",
            badge: 15
          },
        ],
      },
  ...
  },
  {
    ...
    items: [
      {
        label: "Каталог услуг",
        href: "/demo/application/owner/modules/services",
        icon: "🎯",
        ...
        children: [
          { 
            ...
            href: "/demo/application/owner/modules/services/social",
            description: "Поддержка граждан",
            badge: 18
          },
          { 
            label: "Медицинские услуги", 
            href: "/demo/application/owner/modules/services/medical",
            description: "Здравоохранение",
            badge: 12
          },
          { 
            label: "Услуги доставки", 
            href: "/demo/application/owner/modules/services/delivery",
            description: "Курьерские услуги",
            badge: 6
          },
          { 
            label: "Транспортные услуги", 
            href: "/demo/application/owner/modules/services/transport",
            description: "Перевозки",
            badge: 4
          },
          { 
            label: "Услуги автосервиса", 
            href: "/demo/application/owner/modules/services/autoservice",
            description: "Техобслуживание",
            badge: 3
          },
          { 
            label: "Клиентские услуги", 
            href: "/demo/application/owner/modules/services/services",
  ...
  },
  {
    ...
    items: [
      {
        label: "База клиентов",
        href: "/demo/application/owner/modules/clients",
        icon: "👥",
        ...
        children: [
          { 
            label: "Граждане", 
            href: "/demo/application/owner/modules/clients/social",
            description: "Социальные клиенты",
            badge: "856"
          },
          { 
            label: "Пациенты", 
            href: "/demo/application/owner/modules/clients/medical/",
            description: "Медицинские пациенты",
            badge: "234"
          },
          { 
            label: "Курьеры", 
            href: "/demo/application/owner/modules/clients/delivery/",
            description: "Служба доставки",
            badge: "45"
          },
          { 
            label: "Пассажиры", 
            href: "/demo/application/owner/modules/clients/transport/",
            description: "Транспортные клиенты",
            badge: "89"
          },
          { 
            label: "Автовладельцы", 
            href: "/demo/application/owner/modules/clients/autoservice/",
            description: "Автосервис",
            badge: "67"
          },
          { 
            label: "Клиенты", 
            href: "/demo/application/owner/modules/clients/services/",
            description: "Коммерческие клиенты",
            badge: "123"
          },
        ],
      },
    ...
    items: [
      {
        ...
        href: "/demo/application/owner/modules/personnel",
        icon: "🧑‍⚕️",
        description: "Сотрудники и волонтеры",
        children: [
          { 
            label: "Волонтёры", 
            href: "/demo/application/owner/modules/personal/social",
            description: "Социальные работники",
            badge: 23
          },
          { 
            label: "Врачи", 
            href: "/demo/application/owner/modules/personal/medical",
            description: "Медицинский персонал",
            badge: 34
          },
          { 
            label: "Курьеры", 
            href: "/demo/application/owner/modules/personal/delivery",
            description: "Служба доставки",
            badge: 12
          },
          { 
            label: "Водители", 
            href: "/demo/application/owner/modules/personal/transport",
            description: "Транспортный отдел",
            badge: 8
          },
          { 
            label: "Механики", 
            href: "/demo/application/owner/modules/personal/autoservice",
            description: "Автосервис",
            badge: 6
          },
          { 
            label: "Специалисты", 
            href: "/demo/application/owner/modules/personal/services",
            description: "Коммерческий отдел",
            badge: 4
          },
        ],
      },
    ...
    items: [
      {
        ...
        href: "/demo/application/owner/modules/finance",
        icon: "💰",
        description: "Бюджет и отчетность",
        featured: true,
        children: [
          { 
    ...
    items: [
      {
        ...
        href: "/demo/application/owner/modules/settings",
        icon: "⚙️",
    ...
    items: [
      {
        ...
        href: "/demo/application/owner/modules/profile",
        icon: "👑",
        ...
        children: [
          ...
          { 
            label: "На главную", 
            href: "/demo",
            description: "Подробнее о демо-приложениях"
          },
        ],
      },
    ],
...
const DesktopSidebar = () => {
  ...
  const filteredCategories = useMemo(() => {
    if (!searchQuery) return OWNER_CATEGORIES;
    
    return OWNER_CATEGORIES.map(category => ({
      ...category,
      ...
      >
        ...
        <div className="shrink-0 pt-4">
          <div className="flex h-20 items-center gap-3 mb-4">
            <motion.div 
              className="w-12 h-12 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center shadow-2xl"
            ...
            <div className="flex-1 min-w-0">
              <div className="font-bold text-white/90 text-sm truncate">Владелец социальных услуг</div>
              <div className="text-white/70 text-xs font-medium">Социальное управление</div>
            </div>
          </div>
        ...
        <motion.div 
          ...
          whileHover={{ y: -1 }}
          onClick={() => router.push('/demo/application/owner/modules/profile')}
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="text-xs text-white/70 truncate">Директор социальной организации</div>
          </div>
          <motion.span
      ...
      <div className="flex items-center justify-between px-4 h-16">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs text-white/70">Социальное управление</div>
          </div>
        </div>
...
export default function SocialOwnerLayout({
  children,
}: {
  children: React.ReactNode;
}) {
