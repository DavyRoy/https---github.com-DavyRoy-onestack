...
// Конфигурация меню для пассажира общественного транспорта
const USER_CATEGORIES: Category[] = [
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Популярные маршруты", href: "/demo/transport/user/modules/routes/popular" },
          { label: "Маршруты по номерам", href: "/demo/transport/user/modules/routes/numbers" },
          { label: "Оптимальный путь", href: "/demo/transport/user/modules/routes/optimal" },
          { label: "Сохраненные маршруты", href: "/demo/transport/user/modules/routes/saved" },
  ...
  },
  {
    ...
    items: [
      {
        label: "Навигация и карты",
        href: "/demo/transport/user/modules/navigation",
        icon: "🧭",
        children: [
          { label: "Текущее местоположение", href: "/demo/transport/user/modules/navigation" },
          { label: "Построение маршрута", href: "/demo/transport/user/modules/navigation/route" },
          { label: "Ближайшие остановки", href: "/demo/transport/user/modules/navigation/stops" },
          { label: "Время прибытия", href: "/demo/transport/user/modules/navigation/arrival" },
          { label: "Оффлайн карты", href: "/demo/transport/user/modules/navigation/offline" },
          { label: "Избранные места", href: "/demo/transport/user/modules/navigation/favorites" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Разовые билеты", href: "/demo/transport/user/modules/tickets/single" },
          { label: "Проездные", href: "/demo/transport/user/modules/tickets/passes" },
          { label: "Сезонные билеты", href: "/demo/transport/user/modules/tickets/seasonal" },
    ...
    items: [
      {
        ...
        icon: "💳",
        children: [
          { label: "Способы оплаты", href: "/demo/transport/user/modules/payments" },
          { label: "Пополнение баланса", href: "/demo/transport/user/modules/payments/topup" },
          { label: "Автоплатежи", href: "/demo/transport/user/modules/payments/auto" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Любимые маршруты", href: "/demo/transport/user/modules/tracking/favorites" },
          { label: "Уведомления", href: "/demo/transport/user/modules/tracking/notifications" },
          { label: "Задержки транспорта", href: "/demo/transport/user/modules/tracking/delays" },
          { label: "Загруженность", href: "/demo/transport/user/modules/tracking/crowding" },
          { label: "Альтернативные маршруты", href: "/demo/transport/user/modules/tracking/alternatives" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Частые маршруты", href: "/demo/transport/user/modules/trips/frequent" },
          { label: "Время в пути", href: "/demo/transport/user/modules/trips/duration" },
          { label: "Расходы на транспорт", href: "/demo/transport/user/modules/trips/expenses" },
          { label: "Экология", href: "/demo/transport/user/modules/trips/ecology" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Частые вопросы", href: "/demo/transport/user/modules/support/faq" },
          { label: "Обратная связь", href: "/demo/transport/user/modules/support/feedback" },
          { label: "Жалобы и предложения", href: "/demo/transport/user/modules/support/complaints" },
          { label: "Экстренная помощь", href: "/demo/transport/user/modules/support/emergency" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Смена роли", href: "/demo/transport/user/modules/profile/roles" },
        ],
      },
    ],
  },
...
const RoleSwitcher = () => {
  ...
  const currentRole = useMemo(() => {
    if (pathname.includes('/admin')) return ROLES[3]; // admin
    if (pathname.includes('/dispatcher')) return ROLES[2]; // dispatcher
    ...
    <div className="hidden lg:fixed lg:inset-y-0 lg:z-40 lg:flex lg:w-80 lg:flex-col">
      ...
      >
        ...
        <div className="shrink-0 pt-4">
          <div className="flex h-20 items-center gap-3 mb-4">
            ...
            <div className="flex-1 min-w-0">
              <div className="font-bold text-white/90 text-sm truncate">Пассажир</div>
              <div className="text-white/70 text-xs font-medium">Поездки и билеты</div>
            </div>
          </div>
        ...
        <motion.div 
          ...
          whileHover={{ y: -1 }}
          onClick={() => router.push('/demo/transport/user/modules/profile')}
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="text-sm font-semibold text-white/90 truncate">Анна Петрова</div>
            <div className="text-xs text-white/70 truncate">Пассажир общественного транспорта</div>
          </div>
          <motion.span
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-white/70 text-xs">Поездки и билеты</div>
            </div>
          </div>
