...
import { TRANSPORT_ROLES, TRANSPORT_MODULES, TRANSPORT_KPI } from '../config';

export default function UserDashboard() {
  const userModules = TRANSPORT_MODULES.filter(module => 
  ...
  const quickActions = [
    {
      title: 'Найти рейс',
      description: 'Поиск по расписанию',
      icon: '🔍',
      href: '/demo/transport/user/modules/timetable',
      color: 'blue'
    },
    {
      title: 'Купить билет',
      ...
      icon: '🎫',
      href: '/demo/transport/user/modules/ticketing',
      color: 'green'
    },
    {
      title: 'Включить уведомления',
      description: 'Подписка на маршруты',
      icon: '🔔',
      href: '/demo/transport/user/modules/notifications',
      color: 'purple'
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              ...
              <span className="text-white font-medium">Пассажир</span>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-6 md:px-8 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <div className="text-2xl font-bold text-white">{TRANSPORT_KPI.user.nearbyTrips}</div>
                  <div className="text-sm text-gray-400">Ближайшие рейсы</div>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <div className="text-2xl font-bold text-white">{TRANSPORT_KPI.user.activeTickets}</div>
                  <div className="text-sm text-gray-400">Мои билеты</div>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <div className="text-2xl font-bold text-white">{TRANSPORT_KPI.user.subscribedRoutes}</div>
                  <div className="text-sm text-gray-400">Подписки</div>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Modules Grid */}
        <section>
          <h2 className="text-2xl font-bold mb-6">Мои модули</h2>
