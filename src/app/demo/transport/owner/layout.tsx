...
// Конфигурация меню для владельца общественного транспорта
const OWNER_CATEGORIES: Category[] = [
  {
    key: "dashboard",
    title: "Главная",
    icon: "🏠",
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Бюджетирование", href: "/demo/transport/owner/modules/financial/budget" },
          { label: "Налоги и отчетность", href: "/demo/transport/owner/modules/financial/taxes" },
          { label: "Финансовое планирование", href: "/demo/transport/owner/modules/financial/planning" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        icon: "🏢",
        children: [
          { label: "Стратегия развития", href: "/demo/transport/owner/modules/business" },
          ...
          { label: "Конкурентный анализ", href: "/demo/transport/owner/modules/business/competitors" },
          { label: "Риск-менеджмент", href: "/demo/transport/owner/modules/business/risk" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Автоматизация", href: "/demo/transport/owner/modules/operations/automation" },
          { label: "Стандарты качества", href: "/demo/transport/owner/modules/operations/quality" },
          { label: "Бизнес-модели", href: "/demo/transport/owner/modules/operations/models" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Экологичность", href: "/demo/transport/owner/modules/fleet/ecology" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Обучение и развитие", href: "/demo/transport/owner/modules/hr/training" },
          { label: "Кадровый резерв", href: "/demo/transport/owner/modules/hr/reserve" },
        ],
      },
    ],
  },
  {
    ...
    items: [
      {
        label: "Клиентская аналитика",
        href: "/demo/transport/owner/modules/customers",
        icon: "💼",
        children: [
          { label: "База пассажиров", href: "/demo/transport/owner/modules/customers" },
          { label: "LTV и удержание", href: "/demo/transport/owner/modules/customers/ltv" },
          { label: "Сегментация пассажиров", href: "/demo/transport/owner/modules/customers/segmentation" },
          { label: "Лояльность и NPS", href: "/demo/transport/owner/modules/customers/loyalty" },
          { label: "Воронка использования", href: "/demo/transport/owner/modules/customers/funnel" },
          { label: "Прогноз оттока", href: "/demo/transport/owner/modules/customers/churn" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Рекламные кампании", href: "/demo/transport/owner/modules/marketing/campaigns" },
          { label: "Бренд-менеджмент", href: "/demo/transport/owner/modules/marketing/brand" },
          { label: "Анализ ROI", href: "/demo/transport/owner/modules/marketing/roi" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Кастомизация отчетов", href: "/demo/transport/owner/modules/reports/custom" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        href: "/demo/transport/owner/modules/development",
        icon: "🚀",
        children: [
          { label: "Стратегия роста", href: "/demo/transport/owner/modules/development" },
          { label: "Инвестиции и финансирование", href: "/demo/transport/owner/modules/development/investments" },
          { label: "Масштабирование", href: "/demo/transport/owner/modules/development/scaling" },
          { label: "Инновации", href: "/demo/transport/owner/modules/development/innovation" },
          { label: "Партнерские программы", href: "/demo/transport/owner/modules/development/partnerships" },
          { label: "Бизнес-планирование", href: "/demo/transport/owner/modules/development/planning" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Резервное копирование", href: "/demo/transport/owner/modules/settings/backup" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Настройки безопасности", href: "/demo/transport/owner/modules/profile/security" },
          { label: "Подписка и тарифы", href: "/demo/transport/owner/modules/profile/subscription" },
          { label: "Смена роли", href: "/demo/transport/owner/modules/profile/roles" },
        ],
      },
    ],
  },
...
const RoleSwitcher = () => {
  ...
  const currentRole = useMemo(() => {
    if (pathname.includes('/owner')) return ROLES[4]; // owner
...
const MobileTabbar = () => {
  ...
  const categories = useMemo(() => OWNER_CATEGORIES, []);
      ...
      >
        ...
        <div className="shrink-0 pt-4">
          <div className="flex h-20 items-center gap-3 mb-4">
            <motion.div 
              className="w-12 h-12 rounded-2xl bg-gradient-to-br from-indigo-500 to-blue-500 flex items-center justify-center shadow-2xl"
            ...
            <div className="flex-1 min-w-0">
              <div className="font-bold text-white/90 text-sm truncate">Владелец</div>
              <div className="text-white/70 text-xs font-medium">Управление бизнесом</div>
            </div>
          </div>
        ...
        <motion.div 
          ...
          whileHover={{ y: -1 }}
          onClick={() => router.push('/demo/transport/owner/modules/profile')}
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="text-sm font-semibold text-white/90 truncate">Александр Волков</div>
            <div className="text-xs text-white/70 truncate">Владелец "Городской Транспорт"</div>
          </div>
          <motion.span
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-white/70 text-xs">Управление бизнесом</div>
            </div>
          </div>
