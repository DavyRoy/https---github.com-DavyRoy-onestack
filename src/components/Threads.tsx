...
export default function Threads({
  ...
  useEffect(() => {
    ...
    // ResizeObserver точнее, чем window.resize
    ...
    const onVisibility = () => {
      ...
      if (!pausedRef.current && rafRef.current == null) {
