...
const KIND_OPTIONS: ReadonlyArray<[Kind, string]> = [
  ...
  ["dashboard", "Админка / дашборд"],
  ["portal", "Личный кабинет / портал"],
] as const;
...
// актуальные контакты
const EMAIL = "info@onestack24.ru";
const PHONE_RAW = "+7 (910) 948 61 06";
const PHONE_TEL = "+79109486106";
const SITE_URL = "https://onestack24.ru";
...
export default function WebAppContact() {
  ...
  // из калькулятора веб-приложений
  ...
  // нормализация телефона (разрешаем + и цифры)
  ...
  const onSubmit = useCallback(
    async (e: React.FormEvent<HTMLFormElement>) => {
      ...
      try {
        ...
        setSending(true);
        const res = await fetch("/api/contact-app", {
          method: "POST",
          body: fd,
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <motion.div {...fade(0)}>
          ...
          <h2 id="contact-title" className="mt-2 text-3xl sm:text-4xl md:text-5xl font-extrabold leading-tight">
            Веб-приложение — расскажите о задаче, подготовим решение и смету
          </h2>
          <p className="mt-4 text-white/70 max-w-3xl">
            Ответим в рабочие часы в течение дня. Если удобно — приложите user flow, спецификацию или презентацию.
          </p>
        </motion.div>
        ...
        <div className="mt-10 grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <motion.aside {...fade(0.05)} className="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
            ...
            <div className="mt-4 space-y-3 text-white/80">
              <div className="flex items-center gap-3">
                ...
                <a href={`mailto:${EMAIL}`} className="hover:underline" rel="nofollow">
                  {EMAIL}
                </a>
              </div>
              <div className="flex items-center gap-3">
                ...
                <a href={`tel:${PHONE_TEL}`} className="hover:underline" rel="nofollow">
                  {PHONE_RAW}
                </a>
              </div>
              <div className="flex items-center gap-3">
                ...
                <a href={SITE_URL} target="_blank" rel="noopener nofollow" className="hover:underline">
                  onestack24.ru
                </a>
              </div>
            </div>
          ...
          >
            ...
            <div className="mt-6">
              ...
              <div className="mt-3 flex flex-wrap gap-2" role="group" aria-label="Типы приложений">
            ...
            {/* сообщение */}
            <div className="mt-6">
              <Label>Опишите задачу / ключевые фичи / интеграции</Label>
              <textarea
                id={messageId}
                name="message"
                value={form.message}
                ...
                placeholder="Какие роли пользователей? Нужны ли интеграции (CRM, платежи, сторонние API)?"
            ...
            {/* файл */}
            <div className="mt-4">
              <Label>Бриф / user flow / презентация (необязательно)</Label>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "ContactPage",
            name: "Контактная форма — веб-приложения",
      ...
      <Script id="ym-init" strategy="afterInteractive">
        {`
          ...
          })(window, document, 'script', 'https://mc.yandex.ru/metrika/tag.js?id=103909522', 'ym');
          ym(103909522, 'init', { ssr:true, webvisor:true, clickmap:true, ecommerce:"dataLayer", accurateTrackBounce:true, trackLinks:true });
        `}
      </Script>
      <noscript>
        <div>
        ...
        {options.map((o) => (
          <button
            ...
            className={`rounded-full px-4 py-2 text-sm border transition ${
              value === o.value ? "bg-white text-black border-white" : "border-white/30 text-white/85 hover:bg-white/10"
            }`}
          >
            {o.label}
          </button>
