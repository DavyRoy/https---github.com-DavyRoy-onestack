// src/app/components/SiteCorporate.tsx
"use client";
...
export default function SiteCorporate() {
  const reduced = useReducedMotion();

  const features = [
    "Разделы: услуги, проекты, блог, вакансии, контакты",
    "Гибкая админ-панель и роли доступа",
    "Мультиязычность и локализация (i18n)",
    "SEO: карта сайта, метаданные, микроразметка",
    "Интеграции: CRM, почтовые сервисы, аналитика",
  ];
      ...
      "@graph": [
        {
          ...
          serviceType: "Корпоративный сайт",
          provider: {
            "@type": "Organization",
            name: "OneStack",
            url: SITE_URL,
          ...
          availableChannel: {
            "@type": "ServiceChannel",
            serviceUrl: `${SITE_URL}/sites#corporate`,
          },
          description:
            "Полноценный корпоративный портал: разделы, блог, вакансии, гибкое управление контентом. Готов к росту, i18n, интеграциям и SEO.",
          ...
          url: `${SITE_URL}/sites#corporate`,
          keywords:
            "корпоративный сайт, разработка корпоративного сайта, i18n, headless cms, seo, интеграции crm",
        },
        {
          "@type": "BreadcrumbList",
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Корпоративный сайт", item: `${SITE_URL}/sites#corporate` },
          ],
        },
        {
          "@type": "ItemList",
          name: "Преимущества корпоративного сайта",
  ...
  // события аналитики на клики по CTA
  const onCalcClick = () => {
    try {
      // @ts-ignore
      ...
      if (typeof window !== "undefined" && typeof window.ym === "function") {
        // @ts-ignore
        window.ym(YM_ID, "reachGoal", "cta_corporate_calc");
      }
    } catch {}
  };
  ...
  const onContactClick = () => {
    try {
      ...
      if (typeof window !== "undefined" && typeof window.ym === "function") {
        // @ts-ignore
        window.ym(YM_ID, "reachGoal", "cta_corporate_contact");
      }
    } catch {}
  };
  ...
  return (
    ...
    >
      ...
      {/* мягкие свечения как на остальных секциях */}
      <div
        aria-hidden
      ...
      >
        ...
        <div>
          ...
          <motion.h2
            id="corporate-title"
            {...(reduced ? {} : fadeUp(0.05))}
            className="mt-2 font-extrabold leading-tight text-[clamp(28px,4.5vw,48px)] tracking-tight"
          >
            Структура, масштаб, контент
          </motion.h2>
          ...
          >
            Полноценный корпоративный портал: разделы, новости, блог, вакансии и гибкое
            управление контентом. Готов к росту и интеграциям.
          </motion.p>
          ...
          <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row gap-3 sm:gap-4">
            <Link
              ...
              aria-label="Перейти к калькулятору стоимости корпоративного сайта"
            >
            ...
            <Link
              ...
              className="inline-flex items-center justify-center rounded-full border border-white/20
                         ...
                         text-[clamp(13px,1.7vw,16px)]"
              aria-label="Оставить заявку на корпоративный сайт"
            >
              Оставить заявку
            </Link>
          </div>
        ...
        {/* Правая колонка — картинка (адаптив, не обрезается) */}
        <motion.div
          {...(reduced
            ? {}
            : {
        ...
        >
          <Image
            src="/site_corp.png"
            alt="Корпоративный сайт: пример интерфейса, SEO и интеграции"
            fill
            priority
